...
//   // --- STORAGE HELPER (Added to sync with Album logic) ---
...
//     } else {
//         try {
//             // Hum single song play karte waqt bhi current artist ki puri list queue mein dalenge 
//             // taaki user 'Next' kar sake
...
//             await TrackPlayer.skip(clickedIndex); // Clicked song par jao
//             await TrackPlayer.play();
            
//             // Storage mein poori list aur current index save karo
...
//             // Storage update yahan bhi kar sakte ho agar queue persist karni hai
//         } else {
...
//         </TouchableOpacity>
//         <Text style={styles.headerCenterTitle} numberOfLines={1}>{artistData?.name}</Text>
...
//                   <Text style={styles.statsTxt}>Artist</Text>
//                   <Text style={styles.statsSeparator}>|</Text>
//                   <Text style={styles.statsTxt}>{loading ? '...' : songs.length} Songs</Text>
//               </View>

//               <View style={styles.actionBtnRow}>
//                   <TouchableOpacity style={[styles.mainBtn, styles.btnOrange]} onPress={handlePlayAll}>
//                       <Ionicons name="shuffle" size={20} color="#FFFFFF" />
//                       <Text style={styles.btnTxtWhite}>Shuffle</Text>
//                   </TouchableOpacity>

//                   <TouchableOpacity style={[styles.mainBtn, styles.btnLightOrange]} onPress={handlePlayAll}>
//                       <Ionicons name="play-circle" size={22} color="#FF6B00" />
//                       <Text style={styles.btnTxtOrange}>Play</Text>
//                   </TouchableOpacity>
//               </View>
//           </View>

//           <View style={styles.listSubHeader}>
//               <Text style={styles.listTitleText}>Songs</Text>
//               <Text style={styles.SeelistTitleText}>See All</Text>
//           </View>
...
//                      return (
//                         <View key={song.id} style={[styles.trackRow, isPlayingCurrent && styles.activeRowHighlight]}>
...
//                                 <Text style={[styles.trackNameText, isPlayingCurrent && { color: '#FF6B00' }]} numberOfLines={1}>{song.name}</Text>
...
//                                 <TouchableOpacity onPress={() => handlePlayPause(song)}>
//                                     <Ionicons name={isPlayingCurrent && playing ? "pause-circle" : "play-circle"} size={32} color="#FF6B00" />
//                                 </TouchableOpacity>
...
//     imageShadow: { elevation: 10, shadowColor: '#FF6B00', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.3, shadowRadius: 10, borderRadius: 25, marginBottom: 20 },
//     heroImage: { width: width * 0.55, height: width * 0.55, borderRadius: 25, backgroundColor: '#F3F4F6' },
//     artistName: { fontSize: textScale(22), fontWeight: 'bold', color: colors.Black, marginBottom: 8, textAlign: 'center' },
//     statsRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 25 },
//     statsTxt: { fontSize: textScale(12), color: '#64748B', fontWeight: '500' },
//     statsSeparator: { marginHorizontal: 10, color: '#E2E8F0' },
...
//     btnOrange: { backgroundColor: '#FF6B00', elevation: 4 },
//     btnLightOrange: { backgroundColor: '#FFF7ED', borderWidth: 1, borderColor: '#FFEDD5' },
//     btnTxtWhite: { color: '#FFF', fontSize: textScale(16), fontWeight: '600' },
//     btnTxtOrange: { color: '#FF6B00', fontSize: textScale(16), fontWeight: '600' },
//     listSubHeader: { paddingHorizontal: scale(25), marginBottom: 15,flexDirection:"row",justifyContent:"space-between" },
//     listTitleText: { fontSize: textScale(16), fontWeight: 'bold', color: '#1E293B' },
//     SeelistTitleText: { fontSize: textScale(16), fontWeight: 'bold', color:colors.lightornge },
//     songListContainer: { paddingHorizontal: scale(20) },
//     trackRow: { flexDirection: 'row', alignItems: 'center', padding: scale(8), marginBottom: 10 },
//     activeRowHighlight: { backgroundColor: '#FFF7ED', borderRadius: 12 },
//     rowImg: { width: moderateScale(50), height: moderateScale(50), borderRadius: 12, marginRight: 15, backgroundColor: '#f5f5f5' },
//     trackInfo: { flex: 1 },
//     trackNameText: { fontSize: textScale(16), fontWeight: '600', color: '#334155', marginBottom: 3 },
//     trackSubText: { fontSize: textScale(11), color: '#94A3B8' },
